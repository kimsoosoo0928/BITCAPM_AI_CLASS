...
최적의 매개변수 :  Pipeline(steps=[('scaler', MinMaxScaler()),
                ('rf', RandomForestRegressor(min_samples_split=10, n_jobs=-1))])
best_params_ :  {'rf__n_jobs': -1, 'rf__min_samples_split': 10}
best_score_ :  0.8311888091259512
model.score :  0.9137946081654011
R2 :  0.9137946081654011
걸린 시간 :  11.462197542190552
'''
